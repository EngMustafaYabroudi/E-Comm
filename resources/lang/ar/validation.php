...
return [
    ...
    'attributes'           => [
        ...
        'arabic'                => 'العربية',
        'english'               => 'الانكليزية',
        'All rights reserved &copy; for FOODY' => 'كل الحقوق محفوظة  @FOODY',
        'categories' => 'الأصناف',
        'tables' => 'الطاولات',
        'restaurant' => 'مطعم',
        'our categories' => 'أصنافنا',
        'our tables' => 'طاولاتنا',
        'our services' => 'خدماتنا',
        'chairs' => 'كراسي',
        'reserve now' => 'احجز الان',
        'choose your favorite food' => 'اختر طعامك المفضل',
        'online order and delivery' => 'اطلب اونلاين ',
        'reserve your table' => 'احجز الان',
        'feedback' => 'رأيك يهمنا',
        'order now' => 'اطلب الان',
        'created by foody | all rights reserved!' => '',
        'facebook' => 'فيسبوك',
        'twitter' => 'تويتر',
        'instagram' => 'انستغرام',
        'pinterest' => 'بنترست',
        ...
        'en'  => 'تغيير اللغة',
        'Enter name,city or address of Restaurant' => 'ادخل اسم,مدينة أو عنوان مطعم',
        'privecy' => 'الخصوصية'
